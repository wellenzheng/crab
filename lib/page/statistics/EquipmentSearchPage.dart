...
class EquipmentSearchPage extends StatefulWidget {
  @override
  State<StatefulWidget> createState() => EquipmentSearchPageState();
}

class EquipmentSearchPageState extends State<EquipmentSearchPage> {
                  ...
                  child: ListTile(
                    ...
                    onTap: () => () {
                      Navigator.pushNamed(context, 'equipmentDetails',
                          arguments: snapshot.data.postList[index]);
                    },
                  ),
                );
              },
