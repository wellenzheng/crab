...
class EquipmentInfoChangePage extends StatefulWidget {
  @override
  State<StatefulWidget> createState() => EquipmentInfoChangePageState();
}

class EquipmentInfoChangePageState extends State<EquipmentInfoChangePage> {
