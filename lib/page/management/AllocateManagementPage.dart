...
class AllocateManagementPage extends StatefulWidget {
  @override
  State<StatefulWidget> createState() => AllocateManagementPageState();
}

class AllocateManagementPageState extends State<AllocateManagementPage> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      floatingActionButton: FloatingActionButton(
        ...
        onPressed: () {
          Navigator.pushNamed(context, 'allocateRecordAdding');
        },
      ),
    );
  }
