...
class ScrappingManagementPage extends StatefulWidget {
  @override
  State<StatefulWidget> createState() => ScrappingManagementPageState();
}

class ScrappingManagementPageState extends State<ScrappingManagementPage> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      floatingActionButton: FloatingActionButton(
        ...
        onPressed: () {
          Navigator.pushNamed(context, 'scrappedRecordAdding');
        },
      ),
    );
  }
