...
class DropMenuLeftWidget extends StatefulWidget {
  ...
  State<StatefulWidget> createState() {
    ...
    return new DropMenuLeftWidgetState();
  }
}
...
class DropMenuLeftWidgetState extends State<DropMenuLeftWidget> {
  @override
      ...
      return Padding(
        ...
        child: Image(
          image: new AssetImage(
              'resources/dropMenu_images/mmc_dropMenu_check_selected@2x.png'),
          width: 13,
          height: 10,
