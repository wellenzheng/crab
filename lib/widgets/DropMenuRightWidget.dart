...
class DropMenuRightWidget extends StatefulWidget {
  ...
  State<StatefulWidget> createState() {
    ...
    return new DropMenuRightWidgetState();
  }
}

class DropMenuRightWidgetState extends State<DropMenuRightWidget> {
  Widget buildButton(
    int modelIndex,
    int itemIndex,
      ...
      return Container(
        ...
        child: FlatButton(
            ...
            onPressed: () {
              ...
              bloc2.headerFilterData(hasSelectedItem());
            },
            child: Text(
              item.name,
              style: TextStyle(
